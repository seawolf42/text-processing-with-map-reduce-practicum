...
//
// this is code to represent conceptually the lists being generated by the
// ProduceAdjacencyMatrixXXX classes; that can scale with the cluster, but this
// class is limited by the memory of the system it is being used on
